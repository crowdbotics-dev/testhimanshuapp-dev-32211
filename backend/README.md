...
## Project Structure
    ...
    ├── testhimanshuapp_dev_32211  # Django project configurations
...
1. Clone this repo and `cd testhimanshuapp_dev_32211`
...
2. Clone this repo and `cd testhimanshuapp_dev_32211`
